...
function NavIcon({ name }: { name: string }) {
  ...
  switch (name) {
    ...
    case "festival":
      return (
        <svg {...common}>
          <path d="M8 0a.5.5 0 0 1 .5.5v1.2a6.5 6.5 0 0 1 5.8 5.8h1.2a.5.5 0 0 1 0 1h-1.2a6.5 6.5 0 0 1-5.8 5.8v1.2a.5.5 0 0 1-1 0v-1.2A6.5 6.5 0 0 1 1.7 8.5H.5a.5.5 0 0 1 0-1h1.2A6.5 6.5 0 0 1 7.5 1.7V.5A.5.5 0 0 1 8 0zm0 3a5 5 0 1 0 0 10A5 5 0 0 0 8 3zm0 1.5a.75.75 0 1 1 0 1.5.75.75 0 0 1 0-1.5zm2.25 1.75a.75.75 0 1 1 0 1.5.75.75 0 0 1 0-1.5zM5.75 6.25a.75.75 0 1 1 0 1.5.75.75 0 0 1 0-1.5zM8 9.25a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5z" />
        </svg>
      );
    case "mic":
      return (

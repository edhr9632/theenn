...
import { EVENT_CATEGORY_OPTIONS } from "@/components/admin/AdminFormLayout";
...
export default function AdminPressBitsPage() {
  ...
  const resetForm = () => {
    ...
    setCategory(EVENT_CATEGORY_OPTIONS[0]);
    setSortOrder("0");
    setEnabled(true);
      ...
      <div className="admin-panel mb-4">
        ...
        <form className="admin-form-grid" onSubmit={onSubmit}>
          ...
          <label className="admin-field-label">
            Year
            <select className="admin-field" value={year} onChange={(e) => setYear(e.target.value)} required>
